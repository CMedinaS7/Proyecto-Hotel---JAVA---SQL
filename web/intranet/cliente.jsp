...
-->
    ...
    <body>
    <form name="form1" method="post" action="../moduloCliente">
      <table width="452" border="0" align="center">
        <tr>
          <td width="10">&nbsp;</td>
          <td width="163">Ingrese Codigo o DNI:</td>
          <td width="19">&nbsp;</td>
          <td width="237"><label>
        ...
        <tr>
          <td colspan="5"><table width="414" border="0" align="center">
            ...
            <tr>
              ...
              <td><div align="center" class="Estilo1"><a href="../jasper/ClientesActivos.pdf" target="_blank">CLIENTES ACTIVOS</a></div></td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
          </table></td>
