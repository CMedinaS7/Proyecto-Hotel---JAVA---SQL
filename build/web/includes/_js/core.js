var SITE_ROOT = 'http://www.hotel-oxford.ro/';
//var SITE_ROOT = 'http://desero/oxford/';
 try {
...
var relocate = ['servicii','locatie',15+1];	
current_foto = relocate[2]-1;
*/

var cookie_relocate_oxford;
var relocate = [null,null,current_foto+1];
var test_cookie = readCookie('cookie_relocate_oxford');
if(test_cookie&&document.referrer.indexOf('oxford')>-1) { 
...
{  
   string = relocate.join("&");
	createCookie('cookie_relocate_oxford',string,60)
}
