...
if(language=='ro') {
	letter_day = ['D', 'L', 'M', 'M', 'J', 'V', 'S'];
	short_month = ['Ian', 'Feb', 'Mar', 'Apr', 'Mai', 'Iun', 'Iul', 'Aug', 'Sep', 'Oct', 'Noi', 'Dec'];
	week_start_day = 1;
}

else {
	letter_day = ['S', 'M', 'T', 'W', 'T', 'F', 'S'];
	short_month = ['Jan', 'Feb', 'Mar', 'Apr', 'Mai', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
	week_start_day = 0;
}
...
function DateChooser()
{
	...
	var nWeekStartDay = week_start_day;
	var nXOffset = 0;
	var nYOffset = 0;
	var nTimeout = 0;
	...
	var RefreshDisplay = function()
	{
		...
		ndA.setAttribute('title', 'Anul anterior');
		...
		ndA.setAttribute('href', '#');
		ndA.setAttribute('title', 'Luna anterioara');
		ndTH.appendChild(ndA);
	...
	//	ndA.setAttribute('title', 'Current Date');
		...
		ndA.setAttribute('href', '#');
		ndA.setAttribute('title', 'Luna urmatoare');
		ndTH.appendChild(ndA);
		...
		ndA.setAttribute('href', '#');
		ndA.setAttribute('title', 'Anul urmator');
		ndTH.appendChild(ndA);
    ...
    this.Focus = function (asta)
	{   var this_focus = document.getElementById(asta);
		events.add(this_focus, 'click', this.display);
	};
...
function date_chooser_call ()
		{
			...
			*/
			...
			var objLateDateEx2 = new Date();
			objLateDateEx2.setMonth(objLateDateEx2.getMonth() + 12);

			var ndExample2 = document.getElementById('data1_wrapper');
			ndExample2.DateChooser = new DateChooser();
			ndExample2.DateChooser.setXOffset(0);
			ndExample2.DateChooser.setYOffset(23);
			ndExample2.DateChooser.setEarliestDate(objStartDateEx2);
			ndExample2.DateChooser.setLatestDate(objLateDateEx2);
			ndExample2.DateChooser.setStartDate(objStartDateEx2);
			ndExample2.DateChooser.setUpdateField('data1', 'j/n/Y');
		    ndExample2.DateChooser.Focus('data1', 'data1');
			
			var ndExample3 = document.getElementById('data2_wrapper');
			ndExample3.DateChooser = new DateChooser();
			ndExample3.DateChooser.setXOffset(0);
			ndExample3.DateChooser.setYOffset(23);
			ndExample3.DateChooser.setEarliestDate(objStartDateEx2);
			ndExample3.DateChooser.setLatestDate(objLateDateEx2);
			ndExample3.DateChooser.setStartDate(objStartDateEx2);
			ndExample3.DateChooser.setUpdateField('data2', 'j/n/Y');
		    ndExample3.DateChooser.Focus('data2', 'data2');
